...
export default {
  ...
  // Color
  brandPrimary: '#363636',//platform === PLATFORM.IOS ? '#363636' : '#3F51B5',
  brandInfo: '#62B1F6',
  brandSuccess: '#5cb85c',
  brandDanger: '#d9534f',
  brandWarning: '#f0ad4e',
  ...
  activeTab: platform === PLATFORM.IOS ? '#363636' : '#fff',
  sTabBarActiveTextColor: '#363636',
  tabBarActiveTextColor: platform === PLATFORM.IOS ? '#2874F0' : '#fff',
  tabActiveBgColor: platform === PLATFORM.IOS ? '#cde1f9' : '#3F51B5',

  // Header
  toolbarBtnColor: platform === PLATFORM.IOS ? '#363636' : '#fff',
  ...
  toolbarBtnTextColor: platform === PLATFORM.IOS ? '#363636' : '#fff',
  ...
  listNoteSize: 13,
  listItemSelected: platform === PLATFORM.IOS ? '#363636' : '#3F51B5',
  ...
  segmentActiveBackgroundColor: platform === PLATFORM.IOS ? '#363636' : '#fff',
  segmentTextColor: platform === PLATFORM.IOS ? '#363636' : '#fff',
  segmentActiveTextColor: platform === PLATFORM.IOS ? '#fff' : '#3F51B5',
  segmentBorderColor: platform === PLATFORM.IOS ? '#363636' : '#fff',
  ...
  topTabBarActiveTextColor: platform === PLATFORM.IOS ? '#363636' : '#fff',
  topTabBarBorderColor: platform === PLATFORM.IOS ? '#a7a6ab' : '#fff',
  topTabBarActiveBorderColor: platform === PLATFORM.IOS ? '#363636' : '#fff',
