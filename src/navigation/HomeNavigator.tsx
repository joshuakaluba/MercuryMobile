...
import { LocationsScreen, SessionScreen, SessionCreationScreen, CameraScreen } from '../screens';
...
export default function HomeNavigator() {
    return (
        <HomeStack.Navigator>
            <HomeStack.Screen name="LocationsScreen" component={LocationsScreen} options={{ headerShown: true, title: "Locations" }} />
